...
if __name__ == "__main__":
    try:
        ...
        with open(os.path.join(args.path, "full_config.yaml"), "rb") as f:
            config = yaml.load(f.read(), yaml.Loader)
        ...
        # crowd_model = RayRelationModel(model_config, env.observation_spaces[crowd_key], env.action_spaces[crowd_key])
        ...
        family = FamilyGroup.load(args.path, -1)
